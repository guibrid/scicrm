...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Shortorigin'), ['action' => 'edit', $shortorigin->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Shortorigin'), ['action' => 'delete', $shortorigin->id], ['confirm' => __('Are you sure you want to delete # {0}?', $shortorigin->id)]) ?> </li>
...
<div class="shortorigins view large-9 medium-8 columns content">
    <h3><?= h($shortorigin->title) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($shortorigin->products)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($shortorigin->products as $products): ?>
            <tr>
                <td><?= h($products->id) ?></td>
